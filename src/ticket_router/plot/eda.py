"""EDA plotting functions for the multilingual customer support ticket dataset.

All functions accept a pd.DataFrame and return a plt.Figure.
"""
...
# ---------------------------------------------------------------------------
# Fig 1 — Class distributions: Language, Queue, Priority
# ---------------------------------------------------------------------------
...
def plot_class_distribution(df: pd.DataFrame) -> plt.Figure:
    ...
    # --- Panel B: Queue (horizontal, "crest" colormap) ---
    ax = axes[1]
