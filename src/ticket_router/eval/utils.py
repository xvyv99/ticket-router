...
def evaluate_model_dataset(
    ...
    pred_saves = model.load_pred(dataset, sub_name, run_id=run_id, cfg_id=cfg_id)
    pred_file_path = model.get_save_path(dataset, sub_name, run_id=run_id, cfg_id=cfg_id)
